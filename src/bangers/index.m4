...
iwz_twt([I love reading comics where the title is something like, "The Evil Bitch Flips Everyone Off," and it's about a girl who is executed for literally no reason and reincarnates and in her second life she learns to be somewhat mildly but completely justifiably assertive.])

iwz_twt([Gardhwyfar])

iwz_twt([I would become a vegetarian but I could never give up beans.])

iwz_twt([Duct tape is amateur hour. Real pros hold everything together with DIN rails and bolted steel straps.])

iwz_twt([&gt; I wanna make maps serializable.], ["Cool, use JSON, Tiled supports it!"], [&gt; I only have  640k RAM.], ["Binary dumps?"], [&gt; My engine runs on systems with various endiannesses.], ["..."], [Absolute Lunatic (Criminally Insane): Why not use ASN.1?])

iwz_twt([I can be kind of a foodie when I want to be. A "lazy" recipe you can use to recreate the taste of McDonald's fries at home is:], [- Potato Chips (Lays Classic)], [- Pickles], [Just... kinda eat them both at the same time.], [Recommended to eat on a paper towel; no need to use a paper plate.])

iwz_twt([Huge "the vending machine only accepts slips of papyrus and tiny stone tablets with the emperor's face on them" energy.])

iwz_twt([Sir, it seems the feature you're trying to use is one I've never gotten to work. And if I couldn't get it to work, it's probably broken. I suggest you give up, as I have. Have you played Pokemon before? That shit's cash.])

iwz_twt([The nine most terrifying words in the English language are: Hey there! I'm Cortana, and I'm here to help.])

iwz_twt([Thorium is breedable but its submissiveness is debated.])

iwz_twt([So, when you say NX... Do you mean the remote display protocol, the Nintendo Switch kernel, or the open-source re-implementation of the Cave Story engine...?])

iwz_twt([Calling a thunderstorm a "thundercoomer".])

iwz_twt([Getting picked up by the feds for testing the "one rate any weight" policy on the medium flat rate box by filling it with depleted uranium and not sweating the prison time because of work's "unlimited time off" policy.])

iwz_twt([The Big 4 accounting firms, off the top of my head:], [* PWC (easy to remember 'cause Pretty White Chicks)], [* Delorian], [* K&R], [* Ernest to Accounting])

iwz_twt([I walked home from a doctor's appointment today and along the way I saw a bee. Guess global warming is cancelled and everything's fine now.])

iwz_twt([Peach pits are a type of crystal.])

iwz_twt([An MMORPG, but the only interaction with other players is through journal entries and environmental effects generated by the system based on other players' actions, and maybe empty copies of their houses.])

iwz_twt([Cathode Replacement Therapy])

iwz_twt([D*cks out for dBase, as we used to say.])

iwz_twt([The pitfall that always gets me with conversing in Japanese is that to converse in Japanese, one must first be able to converse.])
