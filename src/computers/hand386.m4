...
iwz_p([Some games may require a VESA driver. A VESA driver compatible with the built-in chipset is included as iwz_filename([C:\VESA.COM])! This works with e.g. SimCity 2000. (Thanks to iwz_a_social([https://bitbang.social/@polpo], [Ian Scott]) for pointing this out!)])
